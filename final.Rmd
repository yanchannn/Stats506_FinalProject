...
I conducted a preliminary analysis on the 2012 CBECS data: calculate the 
building-level energy intensity of the electricity with and without 
electrical upgrade and stratifying the results by region and principal 
building activity.
...
Here I focus on five major building activity: office, warehouse, education,
shopping, and service when analyzing since these five categories have
...
I assume the estimates are independent. 
That is if $(\hat{\theta}_1, \hat{v}_1)$ and 
$(\hat{\theta}_1, \hat{v}_1)$ are the estimates and variances for with upgrade
and without upgrade respectively, then the differences and their variances are:
$(\hat{\theta}_1 - \hat{\theta}_2, \hat{v}_1 + \hat{v}_2)$.
